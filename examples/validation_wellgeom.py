...
geom.rock.w_length = 1050.0 #800.0 #m
geom.rock.w_azimuth = 1.55 #0.0*deg #rad
geom.rock.w_dip = 0.521 #0.0*deg #rad
geom.rock.w_proportion = 0.591 #1.0 #m/m
geom.rock.w_phase = 0.642 #0.0*deg #rad
geom.rock.w_toe = -0.0484 #0.0*deg #rad
geom.rock.w_skew = 0.142 #0.0*deg #rad
geom.rock.w_intervals = 7 #breaks in well length
